if(NOT CAres_FOUND)
  ...
  # WIN32 system-level defines (must come before platform-specific defines)
  if(WIN32)
    target_compile_definitions(cares PRIVATE WIN32_LEAN_AND_MEAN)
    target_compile_definitions(cares PRIVATE _CRT_SECURE_NO_DEPRECATE)
    target_compile_definitions(cares PRIVATE _CRT_NONSTDC_NO_DEPRECATE)
    target_compile_definitions(cares PRIVATE _WIN32_WINNT=0x0602)
  endif()

  # Platform-specific defines
  if(CMAKE_SYSTEM_NAME STREQUAL "MSYS")
    # MSYS2 defines __CYGWIN__, so it uses POSIX headers only (no Windows headers)
    # See ares_setup.h: "Under Cygwin things work just as under linux"
    ...
    # DO NOT define HAVE_WINDOWS_H, HAVE_WINSOCK2_H etc. on MSYS2
    # MSYS2 defines __CYGWIN__ and c-ares uses POSIX headers only in that case
  elseif(UNIX)
    if(NOT APPLE)
